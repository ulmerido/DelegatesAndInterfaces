...
namespace Ex04.Menus.Interfaces
{
     public abstract class MenuList : MenuItem
    {
        ...
        public override string ToString()
        {
            ...
            foreach (MenuItem subMenu in r_SubMenuItems)
            {
        ...
        private void menuAction(int i_UserChoise)
        {
            ...
            {
                r_SubMenuItems[i_UserChoise - 1].Show();
            }
        }
        ...
        private int getUserMenuInput()
        {
            ...
            while (!validInput)
            {
                ...
                if (!validInput || (userInput > r_SubMenuItems.Count) || (userInput < 0))
                {
        ...
        {
            if (i_ItemToAdd is MainMenu)
            {
                throw new FormatException("Cant Add a Main Menu");
            }
            else
            {
                r_SubMenuItems.Add(i_ItemToAdd);
            }
        }
    }
}
